...
pub fn v3_pub_record_api(
    ctx: Arc<ApiMqttCtx>,
    router: v3::Router<Session, ServerError>,
) -> v3::Router<Session, ServerError> {
    ...
    router
        .resource(
            ...
            fn_factory_with_config(move |session: v3::Session<Session>| {
...
async fn insert_one(
    ...
    println!(
        ">>>v3_insert_one client_id={} token_id={} project_id={} collection_id={}",
...
async fn update_one(
    ...
    println!(
        ">>>v3_update_one client_id={} token_id={} project_id={} collection_id={}",
        session.state().client_id(),
        session.state().token_id(),
        project_id,
        collection_id
...
async fn delete_one(
    ...
    println!(
        ">>>v3_delete_one client_id={} token_id={} project_id={} collection_id={}",
        session.state().client_id(),
        session.state().token_id(),
        project_id,
        collection_id
