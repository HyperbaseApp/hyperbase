...
pub async fn init(pool: &Pool<Postgres>) {
    ...
    pool.execute("CREATE TABLE IF NOT EXISTS \"projects\" (\"id\" uuid, \"created_at\" timestamptz(6), \"updated_at\" timestamptz(6), \"admin_id\" uuid, \"name\" text, PRIMARY KEY (\"id\"))").await.unwrap();
